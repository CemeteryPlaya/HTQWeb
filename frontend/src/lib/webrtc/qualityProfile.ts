...
export const VIDEO_TARGET_BITRATE_BPS = 12_000_000;
export const VIDEO_TARGET_BITRATE_KBPS = 12_000;
export const AUDIO_TARGET_BITRATE_BPS = 192_000;
export const TARGET_FPS = 60;

export const VIDEO_MIN_WIDTH = 1280;
export const VIDEO_MIN_HEIGHT = 720;
export const VIDEO_TARGET_WIDTH = 1920;
export const VIDEO_TARGET_HEIGHT = 1080;
export const VIDEO_MIN_FPS = 30;
