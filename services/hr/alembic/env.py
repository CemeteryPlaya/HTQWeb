"""Alembic environment configuration for HR Service."""
...
# Per-service bookkeeping table — keeps HR migrations isolated from
...
logging.getLogger("alembic.runtime.migration").info(
    "hr-service alembic bookkeeping: version_table=%s", VERSION_TABLE
)
